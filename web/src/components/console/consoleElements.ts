...
export function createBackDetails(
  ...
  function drawLabel(color: string) {
    ...
    lg.fillText('PUMPY-01', 256, 76)
    lg.globalAlpha = 0.72
    lg.font = `500 30px ${BD_FONT}`
    lg.fillText('DREAMDEX EVENT CONTRACTS', 256, 142)
    lg.globalAlpha = 0.5
...
export function createInternals(device: THREE.Group, accent: string, full: boolean) {
  ...
  g2.fillText('PUMPY-01', 360, 375)
  g2.font = '500 24px -apple-system,"Segoe UI",system-ui,sans-serif'
  g2.fillText('DREAMDEX · EVENTS', 352, 600)
  g2.fillText('REV C', 132, 738)
  g2.fillText('SOMNIA', 760, 690)
...
// on a bright cap, or grey/purple/orange picks on a pale body, still came out invisible. This is the
