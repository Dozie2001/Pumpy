...
export const SCREEN_STATES = {
  noMarket: {
    ...
    body: "DreamDEX isn't opening a compatible Event Contract right now. Your balance is safe and nothing was charged.",
    hint: 'Check back in a bit',
  },
  marketsError: {
    title: "Can't connect",
    body: "We can't reach DreamDEX Event Contracts. It's a connection problem on our side, not your account. Your balance is safe.",
    hint: 'Retrying',
  },
  playsPaused: {
    title: 'Plays paused',
